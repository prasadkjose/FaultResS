 ...
 $(function()
 {
   $(document).ready(function(){
       ...
       ajaxrequest = $.ajax({
           type:"post",
           datatype:"Json",
           url:"/analysisbydate/bylinefilter/",
...
$(function()
{
 $(document).ready(function(){
     ...
     ajaxrequest = $.ajax({
         type:"post",
         datatype:"Json",
         url:"/analysisbydate/bylinepacking/",
         data: (typeof data ==="Json"? data:null),
         success: function(data) { 
...
$(function()
{
 $(document).ready(function(){
     ...
     ajaxrequest = $.ajax({
         type:"post",
         datatype:"Json",
         url:"/analysisbydate/bylinethermal/",
         data: (typeof data ==="Json"? data:null),
         success: function(data) { 
...
$(function()
{
 $(document).ready(function(){
     ...
     ajaxrequest = $.ajax({
         type:"post",
         datatype:"Json",
         url:"/analysisbydate/bylinecorrection/",
         data: (typeof data ==="Json"? data:null),
         success: function(data) { 
